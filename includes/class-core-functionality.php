...
class Core_Functionality {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'post_row_actions', $admin, 'remove_quick_edit', 10, 1 );
		...
		$this->loader->add_filter( 'algolia_excluded_post_types', $algolia, 'post_types_blacklist' );
		$this->loader->add_filter( 'algolia_excluded_taxonomies', $algolia, 'taxonomies_blacklist' );
