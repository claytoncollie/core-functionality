...
function rc_taxonomy_location() {

	$labels = array(
		'name'                       => _x( 'Locations', 'Taxonomy General Name', 'rc' ),
		'singular_name'              => _x( 'Location', 'Taxonomy Singular Name', 'rc' ),
		'menu_name'                  => __( 'Locations', 'rc' ),
...
add_action( 'init', 'rc_taxonomy_location', 0 );