...
function rc_taxonomy_row() {

	$labels = array(
		'name'                       => _x( 'Rows', 'Taxonomy General Name', 'rc' ),
		'singular_name'              => _x( 'Row', 'Taxonomy Singular Name', 'rc' ),
		'menu_name'                  => __( 'Rows', 'rc' ),
...
add_action( 'init', 'rc_taxonomy_row', 0 );