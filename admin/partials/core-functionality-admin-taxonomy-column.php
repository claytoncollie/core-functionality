...
function rc_taxonomy_column() {

	$labels = array(
		'name'                       => _x( 'Columns', 'Taxonomy General Name', 'rc' ),
		'singular_name'              => _x( 'Column', 'Taxonomy Singular Name', 'rc' ),
		'menu_name'                  => __( 'Columns', 'rc' ),
...
add_action( 'init', 'rc_taxonomy_column', 0 );